  ...
  <div class="container">
    ...
    <div class="about-content">
      <div class="about-grid" data-stagger data-stagger-step="120">
        ...
        <article class="about-card" data-reveal data-reveal-delay="80">
          <i class="hn hn-check-solid" aria-hidden="true"></i>
          <h4>From Shelf to Screen</h4>
          <p>Every collection we build celebrates the beauty of gaming’s early days pixel by pixel.</p>
        </article>

        <article class="about-card" data-reveal data-reveal-delay="160">
          <i class="hn hn-check-solid" aria-hidden="true"></i>
          <h4>A Space for Collectors</h4>
          <p>RetroByte is where enthusiasts meet, share, and rediscover forgotten icons of tech culture.</p>
        </article>

        <article class="about-card" data-reveal data-reveal-delay="240">
          <i class="hn hn-check-solid" aria-hidden="true"></i>
          <h4>Preserving the Future of the Past</h4>
          <p>We’re here to keep retro gaming alive — not as nostalgia, but as an experience that still inspires today.</p>
        </article>
      </div>
